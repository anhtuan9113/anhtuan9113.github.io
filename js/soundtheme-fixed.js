...
$(document).ready(function () {
    ...
    // SIDEBAR CLOSE
    $(".main-content, .sidebar-closed-btn").click(function () {
    ...
    $(".soundtheme-btn-search").click(function () {
     //   $(".soundtheme-top-search").fadeToggle();
    ...
    $(".main-content").click(function () {
        ...
        $(".soundtheme-top-search").animate({top: '-75px'}, 500, 'easeInOutExpo', function () {
       //     $(".soundtheme-top-search").fadeToggle();
        });
    });
    ...
    /*$('#searchform').keypress(function (event) {
        ...
        if (keycode == '13') {
            ...
            $(".soundtheme-top-search").animate({top: '-75px'}, 300, 'easeInOutExpo', function () {
                $(".soundtheme-top-search").fadeToggle();
            });
        }
    });*/
